...
/**
 * <br/> PriceManagementRepository <br/>
 ...
 * @version 1.0
 */
public interface PriceManagementRepository extends JpaRepository<PriceData, Long>,
    JpaSpecificationExecutor<PriceData> {
  List<PriceData> getByProduct(ProductData productData);
}
